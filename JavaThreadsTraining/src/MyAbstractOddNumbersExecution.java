...
@MaxValue(2)
public abstract class MyAbstractOddNumbersExecution extends AbstractForkJoinChecker {
	...
	protected String mainClassIdentifier() {
		return ConcurrentOddNumbersSuite.ROOT_CLASS;
	}
...
;
	...
	public static final Object[][] POST_JOIN_PROPERTIES = {
			{"Total Num Odd Numbers", Integer.class},
